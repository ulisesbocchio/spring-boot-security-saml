...
/**
 * Interface to be implemented when using {@link EnableSAMLSSO} and wanting to further customize the SAML Service Provider
 * using the DSL provided by {@link ServiceProviderSecurityBuilder}, which exposes most aspects of configuring
